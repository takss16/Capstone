<x-layout>
    <main class="mw-100 col-11">
        <div class="container">
            ...
            <form id="delete-form" action="{{ route('deleteBabyRecord', ['id' => $patient->id, 'babyId' => $baby->id]) }}" method="POST">
                @csrf
                @method('DELETE')
                ...
                <a href="{{ route('child', ['id' => $patient->id]) }}" class="btn btn-secondary">Cancel</a>
            </form>
        </div>
    </main>
</x-layout>
