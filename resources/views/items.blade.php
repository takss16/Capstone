            ...
            <div id="layoutSidenav_content">
                  ...
                  <div class="container">
                    <div class="tab-content">
                      ...
                      <div class="row g-3">
                        <div class="col-md-4">
                          <label for="itemName" class="form-label">service Name</label>
                          <input type="text" class="form-control" id="itemName" required>
                        </div>
                        <div class="col-md-4">
                          <label for="itemType" class="form-label">service Type</label>
                          <input type="text" class="form-control" id="itemType" required>
                        </div>
                        <div class="col-md-4">
                          <label for="itemPrice" class="form-label">service Price</label>
                          <input type="number" class="form-control" id="itemPrice" required>
                        </div>
                      </div>
                      <button type="submit" class="btn btn-primary mt-3">Add</button>
