        ...
        <div class="container mt-3">
            <div class="text-start mb-3">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    @if ($babyFalse->isNotEmpty())
                    <a  href="{{ route('admin.prevChildForm', ['id' => encrypt($patient->id)]) }}" class="btn btn-primary">
                        <i class="fa-solid fa-eye"></i> Previous Birth
                    </a>
                    @endif
                </div>
        ...
        <div class="col-12 mt-5">
            <div class="card shadow-lg col-12">
                <div class="card-body">
                    ...
                    <div class="col-md-4">
    <a href="{{ route('admin.confirmDeleteBaby', ['id' => encrypt($patient->id), 'babyId' => encrypt($baby->id)]) }}" class="btn btn-danger btn-block">Delete</a>
</div>

                        <div class="col-md-4">
                        <a href="{{ route('admin.printBaby', ['id' => encrypt($patient->id), 'babyId' => encrypt($baby->id)]) }}" class="btn btn-primary btn-block" target="_blank">
                        ...
                        <div class="col-md-4">
    <a href="{{ route('admin.editBaby', ['id' => encrypt($patient->id)]) }}" class="btn btn-primary btn-block">
        ...
        <div class="row">
            <div>
                <form action="{{ route('admin.storeBabyInformation', ['id' => $patient->id]) }}" method="POST">
                    @csrf
